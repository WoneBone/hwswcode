...
port (
    ...
    weights_we0           :in   STD_LOGIC;
    weights_d0            :in   STD_LOGIC_VECTOR(0 downto 0);
    ...
    image_in_we0          :in   STD_LOGIC;
    image_in_d0           :in   STD_LOGIC_VECTOR(15 downto 0);
...
architecture behave of axil_conv2D_BUS1_s_axi is
    ...
    constant ADDR_BIAS_DATA_0    : INTEGER := 16#00010#;
    constant ADDR_BIAS_CTRL      : INTEGER := 16#00014#;
    constant ADDR_WEIGHTS_BASE   : INTEGER := 16#00020#;
    constant ADDR_WEIGHTS_HIGH   : INTEGER := 16#0003f#;
    constant ADDR_MAX_OUT_BASE   : INTEGER := 16#01000#;
    constant ADDR_MAX_OUT_HIGH   : INTEGER := 16#01fff#;
    constant ADDR_IMAGE_OUT_BASE : INTEGER := 16#04000#;
    constant ADDR_IMAGE_OUT_HIGH : INTEGER := 16#07fff#;
    constant ADDR_IMAGE_IN_BASE  : INTEGER := 16#10000#;
    constant ADDR_IMAGE_IN_HIGH  : INTEGER := 16#1ffff#;
    ...
    signal int_bias            : UNSIGNED(0 downto 0) := (others => '0');
    -- memory signals
    signal int_weights_address0 : UNSIGNED(2 downto 0);
    signal int_weights_ce0     : STD_LOGIC;
    signal int_weights_be0     : UNSIGNED(3 downto 0);
    signal int_weights_d0      : UNSIGNED(31 downto 0);
    signal int_weights_q0      : UNSIGNED(31 downto 0);
    signal int_weights_address1 : UNSIGNED(2 downto 0);
    ...
    signal int_max_out_address0 : UNSIGNED(9 downto 0);
    signal int_max_out_ce0     : STD_LOGIC;
    signal int_max_out_be0     : UNSIGNED(3 downto 0);
    signal int_max_out_d0      : UNSIGNED(31 downto 0);
    signal int_max_out_address1 : UNSIGNED(9 downto 0);
    signal int_max_out_ce1     : STD_LOGIC;
    signal int_max_out_q1      : UNSIGNED(31 downto 0);
    signal int_max_out_read    : STD_LOGIC;
    signal int_max_out_write   : STD_LOGIC;
    signal int_max_out_shift0  : UNSIGNED(0 downto 0);
    signal int_image_out_address0 : UNSIGNED(11 downto 0);
    ...
    signal int_image_out_address1 : UNSIGNED(11 downto 0);
    ...
    signal int_image_out_shift0 : UNSIGNED(0 downto 0);
    signal int_image_in_address0 : UNSIGNED(13 downto 0);
    ...
    signal int_image_in_address1 : UNSIGNED(13 downto 0);
    ...
    signal int_image_in_shift0 : UNSIGNED(0 downto 0);
...
port map (
     ...
     q1        => int_weights_q1);
-- int_max_out
int_max_out : axil_conv2D_BUS1_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "S2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_weights_read = '0') and (int_max_out_read = '0') and (int_image_out_read = '0') and (int_image_in_read = '0') else '0';
    RVALID    <= RVALID_t;
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_BIAS_DATA_0 =>
                        rdata_data <= RESIZE(int_bias(0 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                elsif (int_weights_read = '1') then
                    rdata_data <= int_weights_q1;
                elsif (int_max_out_read = '1') then
                    rdata_data <= int_max_out_q1;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_bias(0 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BIAS_DATA_0) then
                    int_bias(0 downto 0) <= (UNSIGNED(WDATA(0 downto 0)) and wmask(0 downto 0)) or ((not wmask(0 downto 0)) and int_bias(0 downto 0));
                end if;
            end if;
        end if;
    end process;
...
-- ----------------------- Memory logic ------------------
    -- weights
    int_weights_address0 <= SHIFT_RIGHT(UNSIGNED(weights_address0), 2)(2 downto 0);
    int_weights_ce0      <= weights_ce0;
    int_weights_address1 <= raddr(4 downto 2) when ar_hs = '1' else waddr(4 downto 2);
    ...
    -- max_out
    int_max_out_address0 <= SHIFT_RIGHT(UNSIGNED(max_out_address0), 1)(9 downto 0);
    int_max_out_ce0      <= max_out_ce0;
    int_max_out_be0      <= SHIFT_LEFT(TO_UNSIGNED(3, 4), TO_INTEGER(UNSIGNED(max_out_address0(0 downto 0)))*2) when max_out_we0 = '1' else (others=>'0');
    int_max_out_d0       <= UNSIGNED(max_out_d0) & UNSIGNED(max_out_d0);
    int_max_out_address1 <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
    int_max_out_ce1      <= ar_hs;
    -- image_out
    int_image_out_address0 <= SHIFT_RIGHT(UNSIGNED(image_out_address0), 1)(11 downto 0);
    int_image_out_ce0    <= image_out_ce0;
    int_image_out_be0    <= SHIFT_LEFT(TO_UNSIGNED(3, 4), TO_INTEGER(UNSIGNED(image_out_address0(0 downto 0)))*2) when image_out_we0 = '1' else (others=>'0');
    int_image_out_d0     <= UNSIGNED(image_out_d0) & UNSIGNED(image_out_d0);
    image_out_q0         <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_image_out_q0, TO_INTEGER(int_image_out_shift0) * 16)(15 downto 0));
    int_image_out_address1 <= raddr(13 downto 2) when ar_hs = '1' else waddr(13 downto 2);
    ...
    -- image_in
    int_image_in_address0 <= SHIFT_RIGHT(UNSIGNED(image_in_address0), 1)(13 downto 0);
    int_image_in_ce0     <= image_in_ce0;
    int_image_in_address1 <= raddr(15 downto 2) when ar_hs = '1' else waddr(15 downto 2);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (ar_hs = '1' and raddr >= ADDR_MAX_OUT_BASE and raddr <= ADDR_MAX_OUT_HIGH) then
                    int_max_out_read <= '1';
                else
                    int_max_out_read <= '0';
                end if;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_max_out_shift0 <= (others=>'0');
            elsif (ACLK_EN = '1') then
                if (max_out_ce0 = '1') then
                    int_max_out_shift0 <= UNSIGNED(max_out_address0(0 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_image_out_shift0 <= (others=>'0');
            elsif (ACLK_EN = '1') then
                if (image_out_ce0 = '1') then
                    int_image_out_shift0 <= UNSIGNED(image_out_address0(0 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_image_in_shift0 <= (others=>'0');
            elsif (ACLK_EN = '1') then
                if (image_in_ce0 = '1') then
                    int_image_in_shift0 <= UNSIGNED(image_in_address0(0 downto 0));
                end if;
            end if;
        end if;
    end process;
