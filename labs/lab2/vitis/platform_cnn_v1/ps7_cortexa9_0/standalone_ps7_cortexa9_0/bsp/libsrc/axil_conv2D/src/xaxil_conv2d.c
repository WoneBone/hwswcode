...
u32 XAxil_conv2d_Get_max_out_BaseAddress(XAxil_conv2d *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Bus1_BaseAddress + XAXIL_CONV2D_BUS1_ADDR_MAX_OUT_BASE);
}

u32 XAxil_conv2d_Get_max_out_HighAddress(XAxil_conv2d *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Bus1_BaseAddress + XAXIL_CONV2D_BUS1_ADDR_MAX_OUT_HIGH);
}

u32 XAxil_conv2d_Get_max_out_TotalBytes(XAxil_conv2d *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XAXIL_CONV2D_BUS1_ADDR_MAX_OUT_HIGH - XAXIL_CONV2D_BUS1_ADDR_MAX_OUT_BASE + 1);
}

u32 XAxil_conv2d_Get_max_out_BitWidth(XAxil_conv2d *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XAXIL_CONV2D_BUS1_WIDTH_MAX_OUT;
}

u32 XAxil_conv2d_Get_max_out_Depth(XAxil_conv2d *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XAXIL_CONV2D_BUS1_DEPTH_MAX_OUT;
}

u32 XAxil_conv2d_Write_max_out_Words(XAxil_conv2d *InstancePtr, int offset, word_type *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XAXIL_CONV2D_BUS1_ADDR_MAX_OUT_HIGH - XAXIL_CONV2D_BUS1_ADDR_MAX_OUT_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Bus1_BaseAddress + XAXIL_CONV2D_BUS1_ADDR_MAX_OUT_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XAxil_conv2d_Read_max_out_Words(XAxil_conv2d *InstancePtr, int offset, word_type *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Bus1_BaseAddress + XAXIL_CONV2D_BUS1_ADDR_MAX_OUT_BASE + (offset + i)*4);
    }
    return length;
}

u32 XAxil_conv2d_Write_max_out_Bytes(XAxil_conv2d *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XAXIL_CONV2D_BUS1_ADDR_MAX_OUT_HIGH - XAXIL_CONV2D_BUS1_ADDR_MAX_OUT_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Bus1_BaseAddress + XAXIL_CONV2D_BUS1_ADDR_MAX_OUT_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XAxil_conv2d_Read_max_out_Bytes(XAxil_conv2d *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Bus1_BaseAddress + XAXIL_CONV2D_BUS1_ADDR_MAX_OUT_BASE + offset + i);
    }
    return length;
}
