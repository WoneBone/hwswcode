# 1 "../../lab1_files/hls/axil_conv2D.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../lab1_files/hls/axil_conv2D.cpp" 2
# 10 "../../lab1_files/hls/axil_conv2D.cpp"
# 1 "../../lab1_files/hls/axil_conv2D.h" 1
...
# 5 "../../lab1_files/hls/axil_conv2D.h" 2
# 16 "../../lab1_files/hls/axil_conv2D.h"
typedef ap_int<8> weight_t;
typedef ap_uint<32> input_image_t;
typedef ap_uint<32> output_image_t;
typedef ap_int<32> bias_t;
typedef ap_uint<14> count_t;
typedef ap_int<21> accum_t;
# 30 "../../lab1_files/hls/axil_conv2D.h"
__attribute__((sdx_kernel("axil_conv2D", 0))) void axil_conv2D(input_image_t image_in[(88 * 88)/4 ],
                 output_image_t image_out[((88 - 3 + 1) * (88 - 3 + 1))/4 ],
                 weight_t weights[3 * 3],
                 bias_t bias);
# 11 "../../lab1_files/hls/axil_conv2D.cpp" 2
...
# 15 "../../lab1_files/hls/axil_conv2D.cpp"
...
#pragma HLS INTERFACE s_axilite port=bias bundle=BUS1
 ...
 loop_m:
    for (count_t m = 0; m < (((88 - 3 + 1) * (88 - 3 + 1) )/4); m++) {
                image_out[m] = 0;
    }
    loop_i:
 ...
 count_t kernel_1d_idx = k * 3 ;
             count_t image_1d_idx = (i + k) * 88 + j ;
                ...
                for (count_t x = 0; x < 3; x++, kernel_1d_idx++, image_1d_idx++) {
                    ...
                    acc += weights[kernel_1d_idx] * (((image_in[image_1d_idx/4 ]>>(image_1d_idx%4)*8)) & 0xFF);
                }
            }
            ...
            image_out[(i * (88 - 3 + 1) + j)/4] |= (acc_sat<< ((i * (88 - 3 + 1) + j)%4)*8);
