set SynModuleInfo {
  {SRCNAME axil_conv2D_Pipeline_loop_m MODELNAME axil_conv2D_Pipeline_loop_m RTLNAME axil_conv2D_axil_conv2D_Pipeline_loop_m
    SUBMODULES {
  ...
  {SRCNAME axil_conv2D_Pipeline_loop_k MODELNAME axil_conv2D_Pipeline_loop_k RTLNAME axil_conv2D_axil_conv2D_Pipeline_loop_k
    SUBMODULES {
      ...
      {MODELNAME axil_conv2D_ama_addmuladd_2ns_7ns_7ns_7ns_13_4_1 RTLNAME axil_conv2D_ama_addmuladd_2ns_7ns_7ns_7ns_13_4_1 BINDTYPE op TYPE all IMPL dsp_slice LATENCY 3}
