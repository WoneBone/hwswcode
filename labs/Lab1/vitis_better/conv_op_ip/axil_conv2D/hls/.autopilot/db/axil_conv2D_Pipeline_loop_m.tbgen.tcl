set moduleName axil_conv2D_Pipeline_loop_m
set isTopModule 0
...
set C_modelName {axil_conv2D_Pipeline_loop_m}
...
set C_modelArgList {
	{ image_out int 32 regular {array 1849 { 0 } 1 1 }  }
}
set hasAXIMCache 0
set hasAXIML2Cache 0
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "image_out", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ image_out_address0 sc_out sc_lv 11 signal 0 } 
	{ image_out_ce0 sc_out sc_logic 1 signal 0 } 
	{ image_out_we0 sc_out sc_logic 1 signal 0 } 
	{ image_out_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "image_out_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "image_out", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	image_out { ap_memory {  { image_out_address0 mem_address 1 11 }  { image_out_ce0 mem_ce 1 1 }  { image_out_we0 mem_we 1 1 }  { image_out_d0 mem_din 1 32 } } }
}
