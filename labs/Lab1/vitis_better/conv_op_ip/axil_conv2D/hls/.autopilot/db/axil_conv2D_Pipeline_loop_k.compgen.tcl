...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler axil_conv2D_ama_addmuladd_2ns_7ns_7ns_7ns_13_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename image_in \
    op interface \
    ports { image_in_address0 { O 11 vector } image_in_ce0 { O 1 bit } image_in_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename weights \
    op interface \
    ports { weights_address0 { O 4 vector } weights_ce0 { O 1 bit } weights_q0 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { acc_1_out { O 21 vector } acc_1_out_ap_vld { O 1 bit } } \
} "
}
