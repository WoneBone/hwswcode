...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/ares/tools/Xilinx/Vitis_HLS/2024.1/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/ares/tools/Xilinx/Vitis_HLS/2024.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/ares/tools/Xilinx/Vitis_HLS/2024.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/ares/tools/Xilinx/Vitis_HLS/2024.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/ares/tools/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0/lib:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/ares/tools/Xilinx/Vitis_HLS/2024.1/lib/lnx64.o/Default:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axil_conv2D.autotvin.dat"
	set constFileTvOut       "axil_conv2D.autotvout.dat"
	set constFileHdlTvIn     "axil_conv2D.autohdltvin.dat"
	set constFileHdlTvOut    "axil_conv2D.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
