...
extern "C" void axil_conv2D(Byte<4>*, Byte<4>*, Byte<1>*, __cosim_s4__);
extern "C" void apatb_axil_conv2D_hw(volatile void * __xlx_apatb_param_image_in, volatile void * __xlx_apatb_param_image_out, volatile void * __xlx_apatb_param_weights, __cosim_s4__* __xlx_apatb_param_bias) {
using hls::sim::createStream;
  // Collect __xlx_image_in__tmp_vec
std::vector<Byte<4>> __xlx_image_in__tmp_vec;
for (size_t i = 0; i < 1936; ++i){
__xlx_image_in__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_image_in)[i]);
}
  int __xlx_size_param_image_in = 1936;
...
__xlx_image_out__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_image_out)[i]);
  ...
  int __xlx_size_param_image_out = 1849;
...
__xlx_weights__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_weights)[i]);
  ...
  // DUT call
  axil_conv2D(__xlx_image_in__tmp_vec.data(), __xlx_image_out__tmp_vec.data(), __xlx_weights__tmp_vec.data(), *__xlx_apatb_param_bias);
