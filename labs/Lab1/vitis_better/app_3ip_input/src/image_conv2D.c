...
void HWSW_conv2D(const unsigned int *matrix_in, unsigned char *matrix_out) {
...
#define IP_BASEADDR_BLUE 0x40020000
	...
	volatile unsigned char *out_image_red = (unsigned char *)(IP_BASEADDR_RED + XAXIL_CONV2D_BUS1_ADDR_IMAGE_OUT_BASE);
    volatile unsigned char *out_image_green = (unsigned char *)(IP_BASEADDR_GREEN + XAXIL_CONV2D_BUS1_ADDR_IMAGE_OUT_BASE);
    volatile unsigned char *out_image_blue = (unsigned char *)(IP_BASEADDR_BLUE + XAXIL_CONV2D_BUS1_ADDR_IMAGE_OUT_BASE);
