...
#define IP_BASEADDR 0x40000000
	...
	volatile unsigned char *in_image = (int *)(IP_BASEADDR + XAXIL_CONV2D_BUS1_ADDR_IMAGE_IN_BASE);
	volatile unsigned char *out_image = (int *)(IP_BASEADDR + XAXIL_CONV2D_BUS1_ADDR_IMAGE_OUT_BASE);
	volatile int *bias_hw = (int *)(IP_BASEADDR + XAXIL_CONV2D_BUS1_ADDR_BIAS_DATA);
	volatile signed char *weights = (int *)(IP_BASEADDR + XAXIL_CONV2D_BUS1_ADDR_WEIGHTS_BASE);
