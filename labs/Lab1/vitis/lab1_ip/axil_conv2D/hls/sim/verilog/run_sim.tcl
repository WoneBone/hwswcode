...
if {[file isfile axil_conv2D.autotvin.dat]} {
	file delete -force axil_conv2D.autotvin.dat
}

if {[file isfile axil_conv2D.autotvout.dat]} {
	file delete -force axil_conv2D.autotvout.dat
}
