set SynModuleInfo {
  {SRCNAME axil_conv2D MODELNAME axil_conv2D RTLNAME axil_conv2D IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME axil_conv2D_flow_control_loop_delay_pipe RTLNAME axil_conv2D_flow_control_loop_delay_pipe BINDTYPE interface TYPE internal_upc_flow_control INSTNAME axil_conv2D_flow_control_loop_delay_pipe_U}
    }
  }
}
