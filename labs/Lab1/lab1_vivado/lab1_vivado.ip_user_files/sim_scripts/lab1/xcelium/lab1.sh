...
#
# Script generated by Vivado on Tue May 13 17:39:10 WEST 2025
...
#
# Usage        : lab1.sh
#                lab1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                lab1.sh [-reset_run]
#                lab1.sh [-reset_log]
#                lab1.sh [-help]
#
...
#                script (type 'lab1.sh -help' for more information).
#
...
# script info
echo -e "lab1.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./lab1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/ec67/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/d47c/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ip/lab1_axil_conv2D_0_0/drivers/axil_conv2D_v1_0/src" +incdir+"/home/ares/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/ec67/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/d47c/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ip/lab1_axil_conv2D_0_0/drivers/axil_conv2D_v1_0/src" +incdir+"/home/ares/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/ec67/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/d47c/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ip/lab1_axil_conv2D_0_0/drivers/axil_conv2D_v1_0/src" +incdir+"/home/ares/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_18 $xmvlog_opts -sv +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/ec67/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/d47c/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ip/lab1_axil_conv2D_0_0/drivers/axil_conv2D_v1_0/src" +incdir+"/home/ares/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/1f8d/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_20 $xmvlog_opts -sv +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/ec67/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/d47c/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ip/lab1_axil_conv2D_0_0/drivers/axil_conv2D_v1_0/src" +incdir+"/home/ares/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/d47c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/ec67/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/d47c/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ip/lab1_axil_conv2D_0_0/drivers/axil_conv2D_v1_0/src" +incdir+"/home/ares/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/ec67/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/d47c/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ip/lab1_axil_conv2D_0_0/drivers/axil_conv2D_v1_0/src" +incdir+"/home/ares/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/ec67/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/d47c/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ip/lab1_axil_conv2D_0_0/drivers/axil_conv2D_v1_0/src" +incdir+"/home/ares/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_31 $xmvlog_opts +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/ec67/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/d47c/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ip/lab1_axil_conv2D_0_0/drivers/axil_conv2D_v1_0/src" +incdir+"/home/ares/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/2ccb/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_32 $xmvlog_opts +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/ec67/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/d47c/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ip/lab1_axil_conv2D_0_0/drivers/axil_conv2D_v1_0/src" +incdir+"/home/ares/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/676c/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_protocol_converter_v2_1_32 $xmvlog_opts +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/ec67/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ipshared/d47c/hdl" +incdir+"../../../../lab1_vivado.gen/sources_1/bd/lab1/ip/lab1_axil_conv2D_0_0/drivers/axil_conv2D_v1_0/src" +incdir+"/home/ares/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.lab1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.lab1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log lab1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./lab1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: lab1.sh [-help]\n\
Usage: lab1.sh [-step]\n\
Usage: lab1.sh [-lib_map_path]\n\
Usage: lab1.sh [-reset_run]\n\
Usage: lab1.sh [-reset_log]\n\
Usage: lab1.sh [-keep_index]\n\
Usage: lab1.sh [-noclean_files]\n\n\
