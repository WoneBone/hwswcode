...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_18 -L processing_system7_vip_v1_0_20 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_18 -L processing_system7_vip_v1_0_20 -L xil_defaultlib -L generic_baseblocks_v2_1_2 -L fifo_generator_v13_2_10 -L axi_data_fifo_v2_1_31 -L axi_register_slice_v2_1_32 -L axi_protocol_converter_v2_1_32 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot lab1_better xil_defaultlib.lab1_better xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim lab1_better -key {Behavioral:sim_1:Functional:lab1_better} -tclbatch cmd.tcl -protoinst "protoinst_files/lab1_better.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ares/tools/Xilinx/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb lab1_better.wdb xsim.dir libdpi.so)
