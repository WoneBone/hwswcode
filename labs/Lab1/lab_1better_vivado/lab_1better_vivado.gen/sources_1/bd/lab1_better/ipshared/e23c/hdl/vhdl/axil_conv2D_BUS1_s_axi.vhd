...
architecture behave of axil_conv2D_BUS1_s_axi is
    ...
    constant ADDR_BIAS_DATA_0    : INTEGER := 16#00020#;
    constant ADDR_BIAS_CTRL      : INTEGER := 16#00024#;
    constant ADDR_WEIGHTS_BASE   : INTEGER := 16#00010#;
    constant ADDR_WEIGHTS_HIGH   : INTEGER := 16#0001f#;
    constant ADDR_IMAGE_IN_BASE  : INTEGER := 16#08000#;
    constant ADDR_IMAGE_IN_HIGH  : INTEGER := 16#0ffff#;
    constant ADDR_IMAGE_OUT_BASE : INTEGER := 16#10000#;
    constant ADDR_IMAGE_OUT_HIGH : INTEGER := 16#17fff#;
    ...
    signal int_image_in_address0 : UNSIGNED(12 downto 0);
    signal int_image_in_ce0    : STD_LOGIC;
    signal int_image_in_q0     : UNSIGNED(31 downto 0);
    signal int_image_in_address1 : UNSIGNED(12 downto 0);
    ...
    signal int_image_in_shift0 : UNSIGNED(1 downto 0);
    signal int_image_out_address0 : UNSIGNED(12 downto 0);
    ...
    signal int_image_out_address1 : UNSIGNED(12 downto 0);
    ...
    signal int_image_out_shift0 : UNSIGNED(1 downto 0);
...
-- ----------------------- Memory logic ------------------
    ...
    -- image_in
    int_image_in_address0 <= SHIFT_RIGHT(UNSIGNED(image_in_address0), 2)(12 downto 0);
    int_image_in_ce0     <= image_in_ce0;
    image_in_q0          <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_image_in_q0, TO_INTEGER(int_image_in_shift0) * 8)(7 downto 0));
    int_image_in_address1 <= raddr(14 downto 2) when ar_hs = '1' else waddr(14 downto 2);
    ...
    -- image_out
    int_image_out_address0 <= SHIFT_RIGHT(UNSIGNED(image_out_address0), 2)(12 downto 0);
    int_image_out_ce0    <= image_out_ce0;
    int_image_out_be0    <= SHIFT_LEFT(TO_UNSIGNED(1, 4), TO_INTEGER(UNSIGNED(image_out_address0(1 downto 0)))) when image_out_we0 = '1' else (others=>'0');
    int_image_out_d0     <= UNSIGNED(image_out_d0) & UNSIGNED(image_out_d0) & UNSIGNED(image_out_d0) & UNSIGNED(image_out_d0);
    int_image_out_address1 <= raddr(14 downto 2) when ar_hs = '1' else waddr(14 downto 2);
    int_image_out_ce1    <= ar_hs;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (image_in_ce0 = '1') then
                    int_image_in_shift0 <= UNSIGNED(image_in_address0(1 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (image_out_ce0 = '1') then
                    int_image_out_shift0 <= UNSIGNED(image_out_address0(1 downto 0));
                end if;
            end if;
        end if;
    end process;
